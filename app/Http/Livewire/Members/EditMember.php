...
class EditMember extends Component
{
    ...
    public function boot(){
        ...
        $memberData = Members::where('id', Session::get('memberToEditId'))->get();
    ...
    public function updateImage(){
        if($this->photo){
            ...
            Members::where('id',Session::get('memberToEditId'))->update(['profile_photo_path'=>$imageUrl]);
        }
    ...
    public function updateNames()
    {
        ...
        Members::where('id',Session::get('memberToEditId'))
            ->update([
                'first_name'=>$this->first_name,
                'last_name'=>$this->last_name
                ]);
    ...
    public function updateMembershipType()
    {
        $this->validate([
            'membership_type'=> 'required|min:3',
        ]);
    ...
    public function updateBodaNumber()
    {
        $this->validate([
            'boda_number'=> 'required|min:3',
        ]);
