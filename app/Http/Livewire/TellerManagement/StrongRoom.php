...
class StrongRoom extends Component
{
    public $item;
    public $source_teller_account;
    public $strong_room_transaction_method;

    public $mirror_account_number_for_cash;
    public $source_teller_amount;
    ...
    public function strongRoomToTeller()
    {
        ...
        if($this->strong_room_transaction_method=="CASH"){
            $this->mirror_account_number=AccountsModel::where('sub_category_code',3050)->value('account_number');
            $this->reference_number='00001';
            //$this->thh;
        }
        // get source account number
        $this->validate(['strong_room_transaction_method'=>'required','mirror_account_number' => 'required', 'strong_room_note' => 'required', 'reference_number' => 'required', 'destination_account_number' => 'required|string']);
        $array_data = ['source_account_number' => $this->mirror_account_number,
            'reference_number' => $this->reference_number,
            'amount' => $this->mirror_account_amount,
            'destination_account_number' => $this->destination_account_number,
