...
//        dd($permissions);
        ...
        foreach ($permissions as $permission) {
            ...
            $rows = DB::table('sub_menus')->select('id', 'menu_id')->where('status',"ACTIVE")->where('id', $permission)->get();
        ...
        $permission_items =[];
        foreach ($permissions as $permission){
            $rows = DB::table('sub_menus')->select('user_action')->where('status',"ACTIVE")->where('id', $permission)->first();
