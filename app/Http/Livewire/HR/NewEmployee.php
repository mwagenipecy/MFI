...
//            'gross_salary' => 'required|numeric',
        ...
        $array=[
            'email'=>$this->email,
            'password'=>$password,   // password is 1234567890
            'department'=>$this->department,
        ...
        approvals::create([
            ...
            'institution' =>1,
            'process_name' => 'addEmployee',
            'process_description' => auth()->user()->name." has registered new employee $this->first_name  $this->last_name",
            'process_code' => 102,
            'process_id' => $id,
            'user_id'  => auth()->user()->id,
            'team_id'  => "",
            'edit_package'=> json_encode($array),
        ]);
