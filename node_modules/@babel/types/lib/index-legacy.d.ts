...
export type Node = Accessor | AnyTypeAnnotation | ArgumentPlaceholder | ArrayExpression | ArrayPattern | ArrayTypeAnnotation | ArrowFunctionExpression | AssignmentExpression | AssignmentPattern | AwaitExpression | BigIntLiteral | Binary | BinaryExpression | BindExpression | Block | BlockParent | BlockStatement | BooleanLiteral | BooleanLiteralTypeAnnotation | BooleanTypeAnnotation | BreakStatement | CallExpression | CatchClause | Class | ClassAccessorProperty | ClassBody | ClassDeclaration | ClassExpression | ClassImplements | ClassMethod | ClassPrivateMethod | ClassPrivateProperty | ClassProperty | CompletionStatement | Conditional | ConditionalExpression | ContinueStatement | DebuggerStatement | DecimalLiteral | Declaration | DeclareClass | DeclareExportAllDeclaration | DeclareExportDeclaration | DeclareFunction | DeclareInterface | DeclareModule | DeclareModuleExports | DeclareOpaqueType | DeclareTypeAlias | DeclareVariable | DeclaredPredicate | Decorator | Directive | DirectiveLiteral | DoExpression | DoWhileStatement | EmptyStatement | EmptyTypeAnnotation | EnumBody | EnumBooleanBody | EnumBooleanClient | EnumDeclaration | EnumDefaultedClient | EnumClient | EnumNumberBody | EnumNumberClient | EnumStringBody | EnumStringClient | EnumSymbolBody | ExistsTypeAnnotation | ExportAllDeclaration | ExportDeclaration | ExportDefaultDeclaration | ExportDefaultSpecifier | ExportNamedDeclaration | ExportNamespaceSpecifier | ExportSpecifier | Expression | ExpressionStatement | ExpressionWrapper | File | Flow | FlowBaseAnnotation | FlowDeclaration | FlowPredicate | FlowType | For | ForInStatement | ForOfStatement | ForStatement | ForXStatement | Function | FunctionDeclaration | FunctionExpression | FunctionParent | FunctionTypeAnnotation | FunctionTypeParam | GenericTypeAnnotation | Identifier | IfStatement | Immutable | Import | ImportAttribute | ImportDeclaration | ImportDefaultSpecifier | ImportNamespaceSpecifier | ImportOrExportDeclaration | ImportSpecifier | IndexedAccessType | InferredPredicate | InterfaceDeclaration | InterfaceExtends | InterfaceTypeAnnotation | InterpreterDirective | IntersectionTypeAnnotation | JSX | JSXAttribute | JSXClosingElement | JSXClosingFragment | JSXElement | JSXEmptyExpression | JSXExpressionContainer | JSXFragment | JSXIdentifier | JSXClientExpression | JSXNamespacedName | JSXOpeningElement | JSXOpeningFragment | JSXSpreadAttribute | JSXSpreadChild | JSXText | LVal | LabeledStatement | Literal | LogicalExpression | Loop | ClientExpression | MetaProperty | Method | Miscellaneous | MixedTypeAnnotation | ModuleDeclaration | ModuleExpression | ModuleSpecifier | NewExpression | Noop | NullLiteral | NullLiteralTypeAnnotation | NullableTypeAnnotation | NumberLiteral | NumberLiteralTypeAnnotation | NumberTypeAnnotation | NumericLiteral | ObjectExpression | ObjectClient | ObjectMethod | ObjectPattern | ObjectProperty | ObjectTypeAnnotation | ObjectTypeCallProperty | ObjectTypeIndexer | ObjectTypeInternalSlot | ObjectTypeProperty | ObjectTypeSpreadProperty | OpaqueType | OptionalCallExpression | OptionalIndexedAccessType | OptionalClientExpression | ParenthesizedExpression | Pattern | PatternLike | PipelineBareFunction | PipelinePrimaryTopicReference | PipelineTopicExpression | Placeholder | Private | PrivateName | Program | Property | Pureish | QualifiedTypeIdentifier | RecordExpression | RegExpLiteral | RegexLiteral | RestElement | RestProperty | ReturnStatement | Scopable | SequenceExpression | SpreadElement | SpreadProperty | Standardized | Statement | StaticBlock | StringLiteral | StringLiteralTypeAnnotation | StringTypeAnnotation | Super | SwitchCase | SwitchStatement | SymbolTypeAnnotation | TSAnyKeyword | TSArrayType | TSAsExpression | TSBaseType | TSBigIntKeyword | TSBooleanKeyword | TSCallSignatureDeclaration | TSConditionalType | TSConstructSignatureDeclaration | TSConstructorType | TSDeclareFunction | TSDeclareMethod | TSEntityName | TSEnumDeclaration | TSEnumClient | TSExportAssignment | TSExpressionWithTypeArguments | TSExternalModuleReference | TSFunctionType | TSImportEqualsDeclaration | TSImportType | TSIndexSignature | TSIndexedAccessType | TSInferType | TSInstantiationExpression | TSInterfaceBody | TSInterfaceDeclaration | TSIntersectionType | TSIntrinsicKeyword | TSLiteralType | TSMappedType | TSMethodSignature | TSModuleBlock | TSModuleDeclaration | TSNamedTupleClient | TSNamespaceExportDeclaration | TSNeverKeyword | TSNonNullExpression | TSNullKeyword | TSNumberKeyword | TSObjectKeyword | TSOptionalType | TSParameterProperty | TSParenthesizedType | TSPropertySignature | TSQualifiedName | TSRestType | TSSatisfiesExpression | TSStringKeyword | TSSymbolKeyword | TSThisType | TSTupleType | TSType | TSTypeAliasDeclaration | TSTypeAnnotation | TSTypeAssertion | TSTypeElement | TSTypeLiteral | TSTypeOperator | TSTypeParameter | TSTypeParameterDeclaration | TSTypeParameterInstantiation | TSTypePredicate | TSTypeQuery | TSTypeReference | TSUndefinedKeyword | TSUnionType | TSUnknownKeyword | TSVoidKeyword | TaggedTemplateExpression | TemplateElement | TemplateLiteral | Terminatorless | ThisExpression | ThisTypeAnnotation | ThrowStatement | TopicReference | TryStatement | TupleExpression | TupleTypeAnnotation | TypeAlias | TypeAnnotation | TypeCastExpression | TypeParameter | TypeParameterDeclaration | TypeParameterInstantiation | TypeScript | TypeofTypeAnnotation | UnaryExpression | UnaryLike | UnionTypeAnnotation | UpdateExpression | UserWhitespacable | V8IntrinsicIdentifier | VariableDeclaration | VariableDeclarator | Variance | VoidTypeAnnotation | While | WhileStatement | WithStatement | YieldExpression;
...
export interface ClientExpression extends BaseNode {
...
export interface OptionalClientExpression extends BaseNode {
...
export interface EnumBooleanClient extends BaseNode {
  type: "EnumBooleanClient";
  id: Identifier;
  init: BooleanLiteral;
}

export interface EnumNumberClient extends BaseNode {
  type: "EnumNumberClient";
  id: Identifier;
  init: NumericLiteral;
}

export interface EnumStringClient extends BaseNode {
  type: "EnumStringClient";
  id: Identifier;
  init: StringLiteral;
}

export interface EnumDefaultedClient extends BaseNode {
...
export interface JSXClientExpression extends BaseNode {
...
export interface TSNamedTupleClient extends BaseNode {
...
export interface TSEnumClient extends BaseNode {
  type: "TSEnumClient";
  id: Identifier | StringLiteral;
  initializer: Expression | null;
}
...
export type LVal = Identifier | ClientExpression | RestElement | AssignmentPattern | ArrayPattern | ObjectPattern | TSParameterProperty | TSAsExpression | TSSatisfiesExpression | TSTypeAssertion | TSNonNullExpression;
...
export type ObjectClient = ObjectMethod | ObjectProperty;
...
export type EnumClient = EnumBooleanClient | EnumNumberClient | EnumStringClient | EnumDefaultedClient;
export type JSX = JSXAttribute | JSXClosingElement | JSXElement | JSXEmptyExpression | JSXExpressionContainer | JSXSpreadChild | JSXIdentifier | JSXClientExpression | JSXNamespacedName | JSXOpeningElement | JSXSpreadAttribute | JSXText | JSXFragment | JSXOpeningFragment | JSXClosingFragment;
...
export function memberExpression(object: Expression | Super, property: Expression | Identifier | PrivateName, computed?: boolean, optional?: true | false | null): ClientExpression;
...
export function assignmentPattern(left: Identifier | ObjectPattern | ArrayPattern | ClientExpression | TSAsExpression | TSSatisfiesExpression | TSTypeAssertion | TSNonNullExpression, right: Expression): AssignmentPattern;
...
export function optionalClientExpression(object: Expression, property: Expression | Identifier, computed: boolean | undefined, optional: boolean): OptionalClientExpression;
...
export function enumBooleanBody(members: Array<EnumBooleanClient>): EnumBooleanBody;
export function enumNumberBody(members: Array<EnumNumberClient>): EnumNumberBody;
export function enumStringBody(members: Array<EnumStringClient | EnumDefaultedClient>): EnumStringBody;
export function enumSymbolBody(members: Array<EnumDefaultedClient>): EnumSymbolBody;
export function enumBooleanClient(id: Identifier): EnumBooleanClient;
export function enumNumberClient(id: Identifier, init: NumericLiteral): EnumNumberClient;
export function enumStringClient(id: Identifier, init: StringLiteral): EnumStringClient;
export function enumDefaultedClient(id: Identifier): EnumDefaultedClient;
...
export function jsxClosingElement(name: JSXIdentifier | JSXClientExpression | JSXNamespacedName): JSXClosingElement;
...
export function jsxClientExpression(object: JSXClientExpression | JSXIdentifier, property: JSXIdentifier): JSXClientExpression;
export function jsxNamespacedName(namespace: JSXIdentifier, name: JSXIdentifier): JSXNamespacedName;
export function jsxOpeningElement(name: JSXIdentifier | JSXClientExpression | JSXNamespacedName, attributes: Array<JSXAttribute | JSXSpreadAttribute>, selfClosing?: boolean): JSXOpeningElement;
...
export function tsTupleType(elementTypes: Array<TSType | TSNamedTupleClient>): TSTupleType;
...
export function tsNamedTupleClient(label: Identifier, elementType: TSType, optional?: boolean): TSNamedTupleClient;
...
export function tsEnumDeclaration(id: Identifier, members: Array<TSEnumClient>): TSEnumDeclaration;
export function tsEnumClient(id: Identifier | StringLiteral, initializer?: Expression | null): TSEnumClient;
...
export function isEnumBooleanClient(node: object | null | undefined, opts?: object | null): node is EnumBooleanClient;
export function assertEnumBooleanClient(node: object | null | undefined, opts?: object | null): void;
...
export function isEnumDefaultedClient(node: object | null | undefined, opts?: object | null): node is EnumDefaultedClient;
export function assertEnumDefaultedClient(node: object | null | undefined, opts?: object | null): void;
export function isEnumClient(node: object | null | undefined, opts?: object | null): node is EnumClient;
export function assertEnumClient(node: object | null | undefined, opts?: object | null): void;
...
export function isEnumNumberClient(node: object | null | undefined, opts?: object | null): node is EnumNumberClient;
export function assertEnumNumberClient(node: object | null | undefined, opts?: object | null): void;
...
export function isEnumStringClient(node: object | null | undefined, opts?: object | null): node is EnumStringClient;
export function assertEnumStringClient(node: object | null | undefined, opts?: object | null): void;
...
export function isJSXClientExpression(node: object | null | undefined, opts?: object | null): node is JSXClientExpression;
export function assertJSXClientExpression(node: object | null | undefined, opts?: object | null): void;
...
export function isClientExpression(node: object | null | undefined, opts?: object | null): node is ClientExpression;
export function assertClientExpression(node: object | null | undefined, opts?: object | null): void;
...
export function isObjectClient(node: object | null | undefined, opts?: object | null): node is ObjectClient;
export function assertObjectClient(node: object | null | undefined, opts?: object | null): void;
...
export function isOptionalClientExpression(node: object | null | undefined, opts?: object | null): node is OptionalClientExpression;
export function assertOptionalClientExpression(node: object | null | undefined, opts?: object | null): void;
...
export function isTSEnumClient(node: object | null | undefined, opts?: object | null): node is TSEnumClient;
export function assertTSEnumClient(node: object | null | undefined, opts?: object | null): void;
...
export function isTSNamedTupleClient(node: object | null | undefined, opts?: object | null): node is TSNamedTupleClient;
export function assertTSNamedTupleClient(node: object | null | undefined, opts?: object | null): void;
...
export function appendToClientExpression<T extends Pick<ClientExpression, 'object' | 'property'>>(member: T, append: ClientExpression['property'], computed?: boolean): T
export function inherits<T extends Node | null | undefined>(child: T, parent: Node | null | undefined): T
export function prependToClientExpression<T extends Pick<ClientExpression, 'object' | 'property'>>(member: T, prepend: ClientExpression['object']): T
...
export function buildMatchClientExpression(match: string, allowPartial?: boolean): (node: Node | null | undefined) => node is ClientExpression
...
export function matchesPattern(node: Node | null | undefined, match: string | ReadonlyArray<string>, allowPartial?: boolean): node is ClientExpression
