...
export default class TypeScriptTransformer extends Transformer {
     ...
     */
    processStringLiteralEnumClient(enumName: string, nameStringCode: string, variableName: string | null): void;
    /**
     ...
     */
    processExplicitValueEnumClient(enumName: string, nameStringCode: string, variableName: string | null): void;
    /**
     ...
     */
    processImplicitValueEnumClient(enumName: string, nameStringCode: string, variableName: string | null, previousValueCode: string | null): void;
}
