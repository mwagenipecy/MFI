...
class Jetstream
{
     ...
     * @var string
     */
    public static $membershipModel = 'App\\Models\\Clientship';
     ...
     * @return static
     */
    public static function useClientshipModel(string $model)
    {
     ...
     * @return void
     */
    public static function addTeamClientsUsing(string $class)
    {
        return app()->singleton(AddsTeamClients::class, $class);
    }
     ...
     * @return void
     */
    public static function inviteTeamClientsUsing(string $class)
    {
        return app()->singleton(InvitesTeamClients::class, $class);
    }
     ...
     * @return void
     */
    public static function removeTeamClientsUsing(string $class)
    {
        return app()->singleton(RemovesTeamClients::class, $class);
    }
