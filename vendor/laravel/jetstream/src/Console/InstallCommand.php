...
class InstallCommand extends Command
{
    ...
    protected function installLivewireTeamStack()
    {
        ...
        copy($stubs.'/livewire/InviteTeamClientTest.php', base_path('tests/Feature/InviteTeamClientTest.php'));
        copy($stubs.'/livewire/LeaveTeamTest.php', base_path('tests/Feature/LeaveTeamTest.php'));
        copy($stubs.'/livewire/RemoveTeamClientTest.php', base_path('tests/Feature/RemoveTeamClientTest.php'));
        copy($stubs.'/livewire/UpdateTeamClientRoleTest.php', base_path('tests/Feature/UpdateTeamClientRoleTest.php'));
...
EOF;
    ...
    protected function installInertiaTeamStack()
    {
        ...
        copy($stubs.'/inertia/InviteTeamClientTest.php', base_path('tests/Feature/InviteTeamClientTest.php'));
        copy($stubs.'/inertia/LeaveTeamTest.php', base_path('tests/Feature/LeaveTeamTest.php'));
        copy($stubs.'/inertia/RemoveTeamClientTest.php', base_path('tests/Feature/RemoveTeamClientTest.php'));
        copy($stubs.'/inertia/UpdateTeamClientRoleTest.php', base_path('tests/Feature/UpdateTeamClientRoleTest.php'));
    ...
    protected function ensureApplicationIsTeamCompatible()
    {
        ...
        // Models...
        copy(__DIR__.'/../../stubs/app/Models/Clientship.php', app_path('Models/Clientship.php'));
        ...
        // Actions...
        copy(__DIR__.'/../../stubs/app/Actions/Jetstream/AddTeamClient.php', app_path('Actions/Jetstream/AddTeamClient.php'));
        ...
        copy(__DIR__.'/../../stubs/app/Actions/Jetstream/InviteTeamClient.php', app_path('Actions/Jetstream/InviteTeamClient.php'));
        copy(__DIR__.'/../../stubs/app/Actions/Jetstream/RemoveTeamClient.php', app_path('Actions/Jetstream/RemoveTeamClient.php'));
