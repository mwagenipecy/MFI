    ...
    <div class="flex gap-2">
        <div class="w-1/4" >
            ...
            <div class="container wrapper-column" >
                ...
                <select   name="country"  wire:model="collection_account_loan_principle" id="country collection_account_loan_principle" class="dropdown mb-4 bg-gray-50 border border-gray-300 text-gray-900 sm:text-xs   rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    @foreach($this->accounts as $account)
                        <option value="{{ $account->id }}" >{{ $account->account_name }}</option>
                    @endforeach
                </select>
            ...
            <div class="flex justify-between gap-2">
                <div class="w-1/2">
                    ...
                    <input wire:model.debounce.500ms="principle_min_value" type="text" id="principle_min_value" class="w-20 p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs
                ...
                <div class="w-1/2">
                    ...
                    <input wire:model.debounce.500ms="principle_max_value" type="text" id="principle_max_value" class="w-20 p-2 text-gray-900 border
            ...
            <div class="flex justify-between gap-2">
                <div class="w-1/2">
                    ...
                    <input wire:model.bounce="min_term" type="number" id="min_term" class="w-20 p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs
                                                 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
                                                 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    @error('min_term')
                    <div class="border border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700 mt-1">
                ...
                <div class="w-1/2">
                    ...
                    <input wire:model.bounce="max_term" type="number" id="max_term" class="w-20 p-2 text-gray-900 border
                                                 border-gray-300 rounded-lg bg-gray-50 sm:text-xs
                                                focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
                                                 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    @error('max_term')
        ...
        <div class="w-1/4 border-l pl-2">
            ...
            <div class="flex mt-2">
                ...
                @if($this->charge_type == 'fixed')
                    <div>
                        <label  class="block mb-2 sm:text-xs font-medium text-gray-900 dark:text-gray-300">Amount</label>
