...
<div class="w-full">
    ...
    <div class="accordion">
        ...
        <div class="accordion-item">
          ...
          <label for="accordion-item-1" class="accordion-title w-full">CREATE NEW AMANA PRODUCT</label>
          <div class="accordion-content">
            <!-- Content for Accordion Item 1 -->

            <div class="panel">
                <livewire:products-management.new-product :product_id="102"/>
            </div>
        ...
        @foreach(App\Models\sub_products::where('product_id','12')->get() as $subProduct)
