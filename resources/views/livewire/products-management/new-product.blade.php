...
<div class="accordion-body py-4 px-5">
    ...
    <div class="flex justify-between">
        ...
        <div>
            ...
            <label for="productStatus" class="relative inline-flex items-center mb-2 cursor-pointer">
                <input type="checkbox" wire:model="productStatus" id="productStatus" class="sr-only peer" >
