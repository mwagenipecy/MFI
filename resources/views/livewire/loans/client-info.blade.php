...
<div>
    ...
    @if(Session::get('LoanStage')=='PROGRESS')
                ...
                <div class="container mx-auto ">
                    <div class="flex flex-col w-full" >
                                ...
                                <table>
                                    ...
                                    <tr class="whitespace-nowrap">
                                        ...
                                        <tr class="whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4">
                                                <p class="text-sm text-gray-900">
                                                    {{$currentClient->next_of_kin_name}}
                                                </p>
                                            </td>
                                        ...
                                        <tr class="whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4">
                                                <p class="text-sm text-gray-900">
                                                    {{$currentClient->next_of_kin_phone}}
                                                </p>
                                            </td>
                                        ...
                                        <tr class="whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4">
                                                <p class="text-sm text-gray-900">
                                                    {{$currentClient->next_of_kin_relationship}}
                                                </p>
                                            </td>
                        ...
                        <div class="bg-white rounded-2xl mt-1 p-4">
                            ...
                            @foreach(DB::table('loans')->where('member_number',$this->member_number)->get() as $loan)
                                <div class="flex w-full">
