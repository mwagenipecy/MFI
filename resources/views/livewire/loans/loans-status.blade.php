                ...
                <div class="flex flex-1 items-center justify-between">
                        <div class="flex flex-shrink-0 items-start">
                            <div class="flex items-center justify-between">
                                ...
                                <div wire:loading.remove wire:target="menuItemClicked">
                                    ...
                                    <div class="flex items-center ">
                                        <p class="font-semibold ml-3 text-slate-600 text-green-900">{{App\Models\MembersModel::where('client_number',Session::get('currentloanClient'))->value('first_name').' '.App\Models\MembersModel::where('client_number',Session::get('currentloanClient'))->value('middle_name').' '.App\Models\MembersModel::where('client_number',Session::get('currentloanClient'))->value('last_name')}}</p>
                        ...
                        <div class="flex ">
                            <div class="flex space-x-4 pr-2">
                                ...
                                <a href="#" wire:click="showTab('client')" class=" @if($this->activeTab == 'client') bg-red-500 text-white  @endif hover:bg-red-500 guarantor  hover:text-white  rounded-md px-3 hover:text-white py-2 text-sm font-medium" aria-current="page"> Member</a>
