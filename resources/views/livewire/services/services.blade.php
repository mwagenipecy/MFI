        ...
        <div class="relative bg-white p-4 sm:p-6 overflow-hidden mb-2 rounded-2xl shadow-md shadow-gray-200" style="height: 116px;">
            ...
            <div class="">
                <div class="flex items-center mb-2 space-x-2 text-sm font-semibold spacing-sm text-slate-600 h-auto">
                    ...
                    <div class="w-full">
                        <div class="text-blue-500">SERVICES STATUS</div>

                        <table >

                            <tbody>
                            <tr>
                                <td ><p class="mr-2">Available Services</p></td>
                                <td ><p class="">:</p></td>
                                <td ><p class="mr-2 ml-2">{{$this->totalServices}} services</p></td>
                            </tr>
                            <tr>
                                <td><p class="mr-2">Inactive Services</p></td>
                                <td>:</td>
                                <td><p class="mr-2 ml-2">{{$this->inActiveSevices}} services</p></td>
                            </tr>
        ...
        <div class="w-full mb-4 " >
            ...
            <div class="bg-white rounded-2xl shadow-md shadow-gray-200 w-full p-1 flex  items-center " style="height: 70px">
                ...
                <div class="inline-flex p-2" >
                    @if (in_array(4, session()->get('permissions')))
                    ...
                    @endif
                        @if (in_array(5, session()->get('permissions')))
