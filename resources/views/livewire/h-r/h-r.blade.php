                            ...
                            <div class="bg-gray-100 rounded px-6 rounded-lg shadow-sm  pt-4 pb-4 ">
                                ...
                                <div class="flex items-stretch">
                                    ...
                                    <div class="w-1/2 ml-2" >
                                        ...
                                        <x-jet-label for="tin_number" value="{{ __('Email') }}" />
                                        <x-jet-input id="tin_number" type="text" name="tin_number" class="mt-1 w-full" wire:model.defer="email" autofocus />
                                        @error('email')
                                        <div class="border border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700 mt-1">
            ...
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center">
                ...
                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    ...
                    <div class="flex items-center bg-gray-200 justify-end py-3 sm:px-6 sm:rounded-bl-lg sm:rounded-br-lg">
                        ...
                        <button type="submit" wire:click="editDepartment()" class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-red-400 border border-transparent rounded-md  focus-visible:ring-2 focus-visible:ring-offset-2 ">
                            Proceed
                        </button>
                    </div>
                </div>
