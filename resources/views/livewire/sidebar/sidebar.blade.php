        ...
        <div
            ...
            <div class="flex justify-between items-center pr-3 sm:px-2 items-center pr-3 sm:px-2 ">
                ...
                <a class="block  flex items-center " href="{{ route('CyberPoint-Pro') }}">
                    <img class="" src="{{ asset('/creditInfoLogor.png') }}"
            ...
            <div class="space-y-8">
                ...
                <div>
                    ...
                    <ul class="mt-3">
                        ...
                        <li id="reloadAll" class="px-3 py-2  onhover   rounded-lg mb-2 @if($this->tab_id == 0) app-bg-color text-white  hover:text-white @else  @endif cursor-pointer "  onmouseover="this.style.backgroundColor='#e63b3d'; this.style.color='#ffffff';" onmouseout="this.style.backgroundColor=''; this.style.color='';">
                                <div wire:click="menuItemClicked(0)" wire:loading.attr="disabled"  class="flex items-center justify-between block text-slate-200 hover:text-white truncate transition duration-150">
                                    <div class="flex items-center">
                                        ...
                                        <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                                            <path class="fill-current @if($this->tab_id == 0) {{ 'text-white-200' }}@else{{ 'text-gray-400' }}@endif" d="M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12 12-5.383 12-12S18.617 0 12 0z" />
                                            <path class="fill-current @if($this->tab_id == 0){{ 'text-red-500' }}@else{{ 'text-red-600' }}@endif" d="M12 3c-4.963 0-9 4.037-9 9s4.037 9 9 9 9-4.037 9-9-4.037-9-9-9z" />
                                            <path class="fill-current @if($this->tab_id == 0){{ 'text-white-200' }}@else{{ 'text-gray-400' }}@endif" d="M12 15c-1.654 0-3-1.346-3-3 0-.462.113-.894.3-1.285L6 6l4.714 3.301A2.973 2.973 0 0112 9c1.654 0 3 1.346 3 3s-1.346 3-3 3z" />
                                        </svg>
                                        </div>
                                        <span class="text-sm hover:text-white  @if($this->tab_id == 0) text-white font-bold  @else  text-gray-500 font-semibold   @endif  ml-3 ">Dashboard</span>
                                    </div>
                                    <!-- Icon -->
                        ...
                        @foreach($this->menuItems as $item)
                            ...
                            @if($item==5  || $item==4 || $item== 62   || $item==21)  @continue  @endif

                            <li  class="px-3 py-2 rounded-lg mb-4 last:mb-0 @if($this->tab_id == $item) app-bg-color text-white  hover:text-white @else  @endif cursor-pointer " onmouseover="this.style.backgroundColor='#e63b3d'; this.style.color='#ffffff';" onmouseout="this.style.backgroundColor=''; this.style.color='';" >
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        @if($item == "1" )
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                    <path class="fill-current @if($this->tab_id == $item) {{ 'text-white-500' }}@else{{ 'text-red-600 hover:text-white' }}@endif" stroke-linecap="round" stroke-linejoin="round" d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z" />
                                                </svg>
                                        ...
                                        @if($item == "4" )
                                                 ...
                                                 <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                    <path  class="fill-current @if($this->tab_id == $item){{ 'text-white-500' }}@else{{ 'text-red-600' }}@endif"  stroke-linecap="round" stroke-linejoin="round" d="M8 7H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3 3m0 0l-3-3m3 3V4" />
                                                </svg>
                                        ...
                                        @if($item == "5" )
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                    <path  class="fill-current @if($this->tab_id == $item){{ 'text-white-500' }}@else{{ 'text-red-600' }}@endif"  stroke-linecap="round" stroke-linejoin="round" d="M17 16v2a2 2 0 01-2 2H5a2 2 0 01-2-2v-7a2 2 0 012-2h2m3-4H9a2 2 0 00-2 2v7a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-1m-1 4l-3 3m0 0l-3-3m3 3V3" />
                                                </svg>
                                        ...
                                        @if($item == "6" )
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                    <path  class="fill-current @if($this->tab_id == $item){{ 'text-white-500' }}@else{{ 'text-red-600' }}@endif"  stroke-linecap="round" stroke-linejoin="round" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
                                                </svg>
                                        ...
                                        @if($item == "7" )
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2  @if( $tab_id == 8 ) stroke-blue-400 font-semibold @else stroke-gray-400 @endif " fill="white" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" width="24" height="24">
                                                    <path  class="fill-current @if($this->tab_id == $item){{ 'text-white-500' }}@else{{ 'text-red-600' }}@endif"  d="M19 2H6c-1.206 0-3 .799-3 3v14c0 2.201 1.794 3 3 3h15v-2H6.012C5.55 19.988 5 19.806 5 19s.55-.988 1.012-1H21V4c0-1.103-.897-2-2-2zm0 14H5V5c0-.806.55-.988 1-1h13v12z"></path>
                                                </svg>
                                        @endif
                                        ...
                                        @if($item == "8" )
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                    <path  class="fill-current @if($this->tab_id == $item){{ 'text-white-500' }}@else{{ 'text-red-600' }}@endif"  stroke-linecap="round" stroke-linejoin="round" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                                                </svg>
                                            ...
                                            @endif
                                             @if($item == "13" )
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="inline-flex items-center justify-center h-6 w-6 text-lg @if( $tab_id == 14 ) text-blue-400 font-semibold @else text-gray-400 @endif ">
                                                    <path   class="fill-current @if($this->tab_id == $item){{ 'text-white-500' }}@else{{ 'text-red-600' }}@endif"   stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                                                </svg>
                                            ...
                                            @endif
                                             @if($item == "49" )
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 @if( $tab_id == 12 ) stroke-blue-400 @else stroke-gray-400 @endif " fill="white" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                    <path   class="fill-current @if($this->tab_id == $item){{ 'text-white-500' }}@else{{ 'text-red-600' }}@endif"   d="M20 3H4c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2h16c1.103 0 2-.897 2-2V5c0-1.103-.897-2-2-2zM4 19V5h7v14H4zm9 0V5h7l.001 14H13z">
                                                    </path>
                                            ...
                                            @if($item == "16" )
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 @if( $tab_id == 16 ) stroke-blue-400 @else stroke-gray-400 @endif " fill="white" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                    <path   class="fill-current @if($this->tab_id == $item){{ 'text-white-500' }}@else{{ 'text-red-600' }}@endif"
                                            ...
                                            @if($item == "21" )
                                                <svg fill="none" class="h-5 w-5 mr-2 @if( $tab_id == 18 ) stroke-blue-400 @else stroke-gray-400 @endif "  stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                    <path class="fill-current  @if($this->tab_id == $item){{ 'text-white-500' }}@else{{ 'text-red-600' }}@endif " stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                            ...
                                            @if($item == "18" )
{{--                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 @if( $tab_id == 18 ) stroke-blue-400 @else stroke-gray-400 @endif " fill="white" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">--}}
{{--                                                    <path   class="fill-current @if($this->tab_id == $item){{ 'text-indigo-300' }}@else{{ 'text-slate-400' }}@endif"--}}
{{--                                                            d="M9 4.5v15m6-15v15m-10.875 0h15.75c.621 0 1.125-.504 1.125-1.125V5.625c0-.621-.504-1.125-1.125-1.125H4.125C3.504 4.5 3 5.004 3 5.625v12.75c0 .621.504 1.125 1.125 1.125z">--}}
{{--                                                    </path>--}}
{{--                                                    <path d="M15 7h3v2h-3zm0 4h3v2h-3z"></path>--}}
{{--                                                </svg>--}}
                                            ...
                                            @endif
                                             ...
                                             @if($item == "50" )
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="h-5 w-5 mr-2 @if( $tab_id == 13 ) stroke-blue-400 @else stroke-gray-400 @endif ">
                                                    ...
                                                    <path   class="fill-current @if($this->tab_id == $item){{ 'text-white-500' }}@else{{ 'text-red-600' }}@endif"   stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                </svg>
                                            @endif
                                        </div>
