                    ...
                    <div class="">
                        ...
                        @if($this->pay_method==="BANK")
                            ...
                            <p class="block mb-2 text-sm font-medium text-slate-600 dark:text-gray-400">
                                Account Number</p>
                            <x-jet-input  type="number" name="acc-mob_number" class="w-full border-gray-300 focus:border-red-500 focus:ring rounded-lg focus:ring-red-200 focus:ring-opacity-50 p-2.5 rounded-md shadow-sm text-sm" wire:model.bounce="acc no" autofocus />
                            {{-- @error('mob_number')
                            <div class="border border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700 mt-1">
                        ...
                        <p for="pay_method" class="block mb-2 text-sm font-medium text-slate-600 dark:text-gray-400">
                            MNOs </p>
                        <select   id="pay_type_two" class="w-full border-gray-300 focus:border-red-500 focus:ring rounded-lg focus:ring-red-200 focus:ring-opacity-50 p-2.5 rounded-md shadow-sm text-sm">
                            <option selected value="">Select</option>
                        ...
                        <select wire:model.bounce="loan_officer" name="member1"
                                class="w-full border-gray-300  focus:border-red-500 focus:ring rounded-lg focus:ring-red-200 focus:ring-opacity-50 p-2.5 rounded-md shadow-sm text-sm">
                            <option selected value="">Select</option>
...
<div class="w-1/3  metric-card  dark:bg-gray-900 border @if($this->item == 5) bg-blue-200 border-blue-200 dark:border-blue-800  @else bg-white  border-gray-200 dark:border-gray-800 @endif rounded-lg p-4 max-w-72 ">
    ...
    <table class="w-full">
        ...
        <tr>
            ...
            <div class="w-1/2 metric-card  dark:bg-gray-900 border @if($this->item == 7) bg-green-200 border-green-200 dark:border-green-800  @else bg-white  border-gray-200 dark:border-gray-800 @endif rounded-lg p-4 max-w-72">
