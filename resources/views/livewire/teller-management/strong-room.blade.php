            ...
            <div class="w-full flex space-x-1">
                <div class="w-1/2 metric-card  dark:bg-gray-900 border bg-white  border-gray-200 dark:border-gray-800 rounded-lg p-4 max-w-72">
                    <div>
                        ...
                        <div class="">
                            ...
                            @error('account_number')
                            <div class="border border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700 mt-1">
                                <p>destination account is required.</p>
                            </div>
                            @enderror
                            <div class="mt-2"></div>
                ...
                <div class="w-1/2 metric-card  dark:bg-gray-900 border bg-white  border-gray-200 dark:border-gray-800 rounded-lg p-4 max-w-72">
                    <div>
                        ...
                        <select wire:model="strong_room_transaction_method"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                            <option selected value="">Select</option>
                            <option selected value="BANK"> From Bank </option>
                            <option selected value="CASH">  From Cash </option>

                        </select>
                        @error('strong_room_transaction_method')
                        <div class="border border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700 mt-1">
                        ...
                        @if($this->strong_room_transaction_method=="BANK")
                        ...
                        <select wire:model="mirror_account_number" name="account_number" id="account_number"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                            <option selected value="">Select</option>
                            @foreach(App\Models\AccountsModel::where('category_code',1000)->get()  as $account2)
