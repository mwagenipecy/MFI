<div>
    <div class="flex gap-4">
        ...
        <a wire:click="viewMember({{$id}})" target="_blank" class="hoverable cursor-pointer text-white bg-gray-100 hover:bg-blue-100 hover:text-blue focus:ring-4 focus:outline-none focus:ring-blue-100 font-medium rounded-lg text-sm p-1 text-center inline-flex items-center mr-2 dark:bg-blue-200 dark:hover:bg-blue-200 dark:focus:ring-blue-200">
            ...
            <span class="hidden text-blue-800 m-2">View</span>
        </a>

{{--        @if (in_array( "Create, edit, and delete member profiles" , session()->get('permission_items')))--}}
