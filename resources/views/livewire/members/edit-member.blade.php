                ...
                <div class="bg-gray-50 overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div>
                        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                            ...
                            <div class="mt-10 sm:mt-0">
                                <x-jet-form-section submit="updateTawi">
                                    <x-slot name="title">
                                        {{ __('Tawi') }}
                                    </x-slot>

                                    <x-slot name="description">
                                        {{ __('Edit the tawi of the member.') }}
                                    </x-slot>
                            ...
                            <div class="mt-10 sm:mt-0">
                                <x-jet-form-section submit="updateBodaNumber">
                                    <x-slot name="title">
                                        {{ __('Boda Number') }}
                                    </x-slot>

                                    <x-slot name="description">
                                        {{ __('Edit the boda number of the member.') }}
                                    </x-slot>
                                    ...
                                    <x-slot name="form">
                                        ...
                                        <!-- Email -->
                                        <div class="col-span-6 sm:col-span-4">
                                            <x-jet-label for="boda_number" value="{{ __('Boda Number') }}" />
                            ...
                            <div class="mt-10 sm:mt-0">
                                <x-jet-form-section submit="updatePhoneNumber">
                                    ...
                                    <x-slot name="form">
                                        ...
                                        <!-- Email -->
                                        <div class="col-span-6 sm:col-span-4">
                                            <x-jet-label for="phone_number" value="{{ __('Boda Number') }}" />
                            ...
                            <div class="mt-10 sm:mt-0">
                                <x-jet-form-section submit="updateMembershipType">
                                    <x-slot name="title">
                                        {{ __('Clientship Type') }}
                                    </x-slot>
