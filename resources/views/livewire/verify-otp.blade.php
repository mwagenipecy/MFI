<div>
    ...
    <div class=" py-3 rounded text-center">
        ...
        <div id="otp" class="flex flex-row justify-center text-center px-2 mt-5">
            <input  class="m-2 border   h-10 w-10 text-center form-control rounded" type="text" id="otp1" maxlength="1" />
            <input  class="m-2 border h-10 w-10 text-center form-control rounded" type="text" id="otp2" maxlength="1" />
            <input  class="m-2 border h-10 w-10 text-center form-control rounded" type="text" id="otp3" maxlength="1" />
            <input class="m-2 border h-10 w-10 text-center form-control rounded" type="text" id="otp4" maxlength="1" />
            <input  class="m-2 border h-10 w-10 text-center form-control rounded" type="text" id="otp5" maxlength="1" />
            <input  class="m-2 border h-10 w-10 text-center form-control rounded" type="text" id="otp6" maxlength="1" />
        </div>
