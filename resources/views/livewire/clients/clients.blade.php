                ...
                <div>
                    ...
                    <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
                        <li class="flex items-center">
                            ...
                            Total Clients: {{ App\Models\MembersModel::count() }}
                        </li>
                        <li class="flex items-center">
                            <svg class="w-3.5 h-3.5 mr-2 text-red-400 dark:text-green-400 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
                            </svg>
                            Active Clients: {{ App\Models\LoansModel::where('status',"ACTIVE")->distinct('member_number')->count() }}
                        </li>
                        <li class="flex items-center">
                            ...
                            New Clients  <span>
                                <span class="ml-2 bg-red-100 text-red-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-red-400 border border-red-400"> {{ App\Models\MembersModel::where('client_status','NEW CLIENT')->count() }}</span>
                            </span>
                        </li>
                    </ul>
                </div>
...
{{--        <div class="bg-white p-4 sm:p-6 gap-6 flex overflow-hidden mb-2 rounded-lg shadow-md shadow-gray-200">--}}
{{--            <button wire:click="viewAllClients" class="flex hover:bg-red-600 w-32 text-center bg-gray-100 items-center justify-center hover:text-white  py-2 px-4 rounded-lg">--}}
{{--                All Clients--}}
{{--            </button>--}}

{{--            <button wire:click="viewPaidClients" class="flex hover:bg-red-600 w-32 text-center bg-gray-100 items-center justify-center hover:text-white py-2 px-4 rounded-lg">--}}
{{--                Paid--}}
{{--            </button>--}}

{{--            <button wire:click="viewNotPaidClients" class="flex hover:bg-red-600 w-32 text-center bg-gray-100 items-center justify-center hover:text-white  py-2 px-4 rounded-lg">--}}
{{--                Not Paid--}}
{{--            </button>--}}
            ...
            @if($this->viewClientDetails)
                ...
                @if($this->viewClientLoanData)
                    ...
                    <div id="printable" class="w-full">
                        <nav class="bg-red-100   rounded-lg pl-2 pr-2 shadow-2xl hideThis">
                            <div class="relative flex h-16 items-center justify-between">
                                <div class="flex flex-1 items-center justify-between">
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div wire:loading.remove wire:target="menuItemClicked">
                                                ...
                                                <div class="flex items-center ">
                                                    ...
                                                    <p class="font-semibold ml-3 text-slate-600 text-green-900">{{App\Models\MembersModel::where('member_number',Session::get('viewMemberLoan'))->value('first_name').' '.App\Models\MembersModel::where('member_number',Session::get('viewMemberLoan'))->value('middle_name').' '.App\Models\MembersModel::where('member_number',Session::get('viewMemberLoan'))->value('last_name')}}</p>
                                    ...
                                    <div class="flex gap-4 ">
                                        ...
                                        <button id="fullscreen-button-open" type="button" class="rounded-full bg-white p-1 text-gray-400 hover:text-blue-200 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                        ...
                        @foreach(App\Models\LoansModel::where('member_number',Session::get('viewMemberLoan'))->get() as $loan)
                            <div class="w-full p-6">
                                <h2 class="text-l font-bold mb-4 text-gray-800">LOAN DETAILS</h2>
                                <h2 class="text-md font-bold mb-4 text-gray-800">Product : {{App\Models\Loan_sub_products::where('sub_product_id',$loan->loan_sub_product)->value('sub_product_name')}}</h2>
                                <div class="w-full flex gap-2 justify-between">
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-gray-700">Client Name:</label>
                                        <p class="mt-1 text-lg text-gray-900">{{App\Models\MembersModel::where('member_number',$loan->member_number)->value('first_name').' '.App\Models\MembersModel::where('member_number',$loan->member_number)->value('middle_name').' '.App\Models\MembersModel::where('member_number',$loan->member_number)->value('last_name')}}
                                        </p>
                                    </div>
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-gray-700">Loan Amount:</label>
                                        <p class="mt-1 text-lg text-gray-900">{{number_format($loan->principle,2)}} TZS</p>
                                    </div>
                                    <div class="hideThis mb-4">
                                        <label class="block text-sm font-medium text-gray-700">Interest Rate:</label>
                                        <p class="mt-1 text-lg text-gray-900">{{$loan->interest}}%</p>
                                    </div>
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-gray-700">Loan Term:</label>
                                        <p class="mt-1 text-lg text-gray-900">{{$loan->tenure}} Days</p>
                                    </div>
                                ...
                                <h3 class="text-md font-semibold mb-4 mt-8 text-gray-800">Repayment Schedule</h3>
                                <div class="overflow-x-auto">
                                    <table class="min-w-full bg-white border border-gray-300">
                                        <thead>
                                        <tr>
                                            <th class="px-4 py-2 border-b-2 border-gray-300 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Installment Date</th>
                                            <th class="px-4 py-2 border-b-2 border-gray-300 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Installment</th>
{{--                                            <th class="px-4 py-2 border-b-2 border-gray-300 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Interest</th>--}}
                                            <th class="hideThis px-4 py-2 border-b-2 border-gray-300 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Interest</th>

                                            <th class="px-4 py-2 border-b-2 border-gray-300 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Principle</th>
                                            <th class="px-4 py-2 border-b-2 border-gray-300 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Balance</th>
                                            <th class="hideThis px-4 py-2 border-b-2 border-gray-300 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Payment</th>
                                            <th class="hideThis px-4 py-2 border-b-2 border-gray-300 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Completion Status</th>

                                            <th class="hideThis px-4 py-2 border-b-2 border-gray-300 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Penalties</th>
                                            <th class="hideThis px-4 py-2 border-b-2 border-gray-300 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Amount in Arrears</th>
                                            <th class="hideThis px-4 py-2 border-b-2 border-gray-300 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Days in Arrears</th>

                                        </tr>
                                        </thead>
                                        <tbody class="text-gray-700">

                                        @foreach (App\Models\loans_schedules::where('loan_id',$loan->loan_id)->get() as $schedule)
                                            <tr>
                                                <td class="px-4 py-2 border-b border-gray-300">{{ $schedule->installment_date }}</td>
                                                <td class="px-4 py-2 border-b border-gray-300">{{ number_format($schedule->installment,2) }}</td>
{{--                                                <td class="px-4 py-2 border-b border-gray-300">{{ number_format($schedule->interest,2) }}</td>--}}
                                                <td class="hideThis px-4 py-2 border-b border-gray-300">{{ number_format($schedule->interest,2) }}</td>
                                                <td class="px-4 py-2 border-b border-gray-300">{{ number_format($schedule->principle,2) }}</td>
                                                <td class="px-4 py-2 border-b border-gray-300">{{ number_format($schedule->balance,2) }}</td>
                                                <td class="hideThis px-4 py-2 border-b border-gray-300">{{ number_format($schedule->payment,2) }}</td>
                                                <td class="hideThis px-4 py-2 border-b border-gray-300">{{ $schedule->completion_status }}</td>

                                                <td class="hideThis px-4 py-2 border-b border-gray-300">{{ number_format($schedule->penalties,2) }}</td>
                                                <td class="hideThis px-4 py-2 border-b border-gray-300">{{ number_format($schedule->amount_in_arrears,2) }}</td>
                                                <td class="hideThis px-4 py-2 border-b border-gray-300">{{ number_format($schedule->days_in_arrears) }}</td>
                        ...
                        <script>
                            ...
                            $(document).ready(function() {
                                ...
                                function toggleFullscreenx() {

                                    // Get all div elements with the class 'hide'
                                    var hiddenDivs = document.querySelectorAll('.hideThis');

                                    // Loop through each hidden div and hide it
                                    hiddenDivs.forEach(function(div) {
                                        div.style.display = 'none'; // Hide the div by setting display to 'none'
                                    });
                                ...
                                $("#fullscreen-button-open").click(toggleFullscreenx);
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div>
                                                        <button type="button" class="flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                                            <?php
                                                            $urlValue=  \App\Models\MembersModel::where('id',Session::get('viewClientId'))->value('profile_photo_path');
                                                            ?>
                                                            @if($urlValue)
{{--                                                                <img class="mb-3 w-32 h-32 rounded-full shadow-lg" src="{{$urlValue}}">--}}
                                                    ...
                                                    <p class="font-semibold ml-3 text-slate-600 text-red-900"> {{App\Models\MembersModel::where('id',Session::get('viewClientId'))->value('first_name').' '.App\Models\MembersModel::where('id',Session::get('viewClientId'))->value('middle_name').' '.App\Models\MembersModel::where('id',Session::get('viewClientId'))->value('last_name')}}</p>

                                                </div>
                                                <div class="text-red-400 ml-4 mr-5 ">
                                                    <div class="ml-12 text-blue-900 font-bold">
                                                        {{App\Models\MembersModel::where('id',Session::get('viewClientId'))->value('client_status')}}
                                                    </div>
                                                </div>
                        ...
                        <div class="w-full h-full grid p-2 ">
                            <?php        $employees=\App\Models\MembersModel::where('id',session()->get('viewClientId'))->get();                      ?>
                                                                            ...
                                                                            <tr class="whitespace-nowrap">
                                                                                ...
                                                                                <td class="px-6 py-4">
                                                                                    <p class="text-xs text-gray-900">
                                                                                        {{ DB::table('members')->where('id', Session::get('viewClientId'))->value($variables[$i]['name']) }}
                                                                                    </p>
                                                                                </td>
                                                                            </tr>
                                                                        @endif
                    ...
                    <div class="w-full">
                        ...
                        <div class="col-span-6 sm:col-span-4 mb-4">
                            ...
                            <select wire:model.bounce="parentClient" name="parentClient" id="parentClient" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                @foreach(App\Models\MembersModel::all() as $Client)
                                ...
                                <div class="w-full p-4 ">
                                    @if($this->clientSelected)
                                        ...
                                        <div class="flex items-center mb-2 text-sm spacing-sm text-slate-600 mt-2" >
                                            ...
                                            <p>{{ App\Models\MembersModel::where('id', $this->clientSelected)->value('first_name') }}</p>
                                        </div>
                ...
                <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center">
                    ...
                    <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                    ...
                                    <div class="max-w-2xl rounded-lg shadow-sm bg-gray-50">
                                        <div class="m-4">
                                            ...
                                            <section class="bg-white-300 flex flex-col items-center justify-center">
                                                ...
                                                @else
                                                    <img class="block rounded-b w-64" src="{{ asset('storage/app/public/'.$this->profile_photo_path)}}" alt="profile Pic">
                                                @endif
                        ...
                        <div class="flex items-center bg-gray-200 justify-end py-3 sm:px-6 sm:rounded-bl-lg sm:rounded-br-lg">
                            ...
                            {{--                                Proceed--}}
                            {{--                            </button>--}}
                            <button wire:click="updateClient" wire:loading.attr="disabled" class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-red-400 border border-transparent rounded-md focus-visible:ring-2 focus-visible:ring-offset-2">
