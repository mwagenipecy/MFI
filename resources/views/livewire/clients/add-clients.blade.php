            ...
            <div class="flex items-stretch">
                ...
                <div class="w-1/2 ml-2" >
                    ...
                    @enderror
                            ...
                            <x-jet-label for="vehicle_number" value="{{ __('Vehicle/Motorcycle Number') }}" />
                            <x-jet-input id="vehicle_number" type="text" name="vehicle_number" class="mt-1 w-full" wire:model.defer="vehicle_number" autofocus />
                            @error('vehicle_number')
                            <div class="border border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700 mt-1">
                                <p>Vehicle/Motorcycle Number is mandatory.</p>
                            </div>
                            @enderror
                            ...
                            <x-jet-input id="tawi" type="text" name="tawi" class="mt-1 w-full" wire:model.defer="tawi" autofocus />
                            @error('tawi')
                            <div class="border border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700 mt-1">
                                <p>Tawi is mandatory.</p>
                            </div>
                            @enderror
