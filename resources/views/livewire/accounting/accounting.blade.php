            ...
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center">
                ...
                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    ...
                    <div class="flex items-center bg-gray-200 justify-end py-3 sm:px-6 sm:rounded-bl-lg sm:rounded-br-lg">
                        ...
                        <button type="submit" wire:click="updateAccountsAccount" class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-blue-400 border border-transparent rounded-md  focus-visible:ring-2 focus-visible:ring-offset-2 ">
                            Proceed
                        </button>
                    </div>
                </div>
                    ...
                    <div class="w-1/2 mr-2" >
                        ...
                        @if($this->member)
                            ...
                            <table class="w-full">
                                ...
                                @foreach(App\Models\AccountsModel::where('client_number',$this->member)->where('product_number','11')->get() as $account)
                                    @php
                                        $this->account_number = $account->account_number;
                                    @endphp
